...
export default function ProxiesPage() {
    ...
    const [newProxy, setNewProxy] = useState({ host: '', port: '1080', type: 'SOCKS5', username: '', password: '' });
    ...
    const handleAddProxy = () => {
        ...
        const proxy = {
            id: Date.now(),
            host: newProxy.host,
            port: parseInt(newProxy.port) || 1080,
            type: newProxy.type,
            country: '🇧🇷',
            city: 'Brasil',
            latency: 0,
        ...
        setProxyList([proxy, ...proxyList]);
        setNewProxy({ host: '', port: '1080', type: 'SOCKS5', username: '', password: '' });
        setShowModal(false);
    };
    return (
                                ...
                                {proxyList.map((proxy) => {
                                    ...
                                    return (
                                        <tr key={proxy.id}>
                                            ...
                                            <td>
                                                <span style={{ color: getLatencyColor(proxy.latency) }} className="font-medium">
                                            ...
                                            <td>
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <button className="p-2 rounded-lg hover:bg-[var(--bg-glass)] text-[var(--accent-danger)]" title="Remover">
                                                        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
