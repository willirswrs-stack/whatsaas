        ...
        <div className="animate-fadeIn pb-12">
            ...
            <div className="page-header container mx-auto px-4 max-w-7xl flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="page-title">Matriz & Controle de Chips (Warm-up)</h1>
                        <p className="text-sm text-[var(--text-muted)]">Gestão de maturação, aquecimento e saúde dos chips</p>
                    </div>
                </div>
            </div>
