...
export class SyncAllEntities1768779330500 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "contact_tags" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "contact_id" uuid NOT NULL, "tag_id" uuid NOT NULL, "added_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_4e03788e7aac2227880c6fc3f7b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "contacts" DROP COLUMN "opted_out_at"`,
    );
    await queryRunner.query(`ALTER TABLE "contacts" DROP COLUMN "updated_at"`);
    await queryRunner.query(
      `ALTER TABLE "contacts" ADD "email" character varying(255)`,
    );
    await queryRunner.query(
      `ALTER TABLE "contacts" ADD "opted_out" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "contacts" ADD "opted_out_at" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "contacts" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "contacts" ADD "phone" character varying(30)`,
    );
    await queryRunner.query(`ALTER TABLE "contacts" DROP COLUMN "name"`);
    await queryRunner.query(
      `ALTER TABLE "contacts" ADD "name" character varying(255)`,
    );
    await queryRunner.query(`ALTER TABLE "contacts" DROP COLUMN "tenant_id"`);
    await queryRunner.query(
      `ALTER TABLE "contacts" ADD "tenant_id" character varying`,
    );
    await queryRunner.query(`ALTER TABLE "contacts" DROP COLUMN "phone"`);
    await queryRunner.query(
      `ALTER TABLE "contacts" ADD "phone" character varying`,
    );
    await queryRunner.query(`ALTER TABLE "contacts" DROP COLUMN "name"`);
    await queryRunner.query(
      `ALTER TABLE "contacts" ADD "name" character varying`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "contacts" DROP COLUMN "email"`);
    await queryRunner.query(
      `ALTER TABLE "contacts" ADD "updated_at" TIMESTAMP DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "contacts" ADD "opted_out_at" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "contacts" ADD "opted_out" boolean DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "contacts" ADD "email" character varying(255)`,
    );
