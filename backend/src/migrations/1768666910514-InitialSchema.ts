...
export class InitialSchema1768666910514 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "flow_folders" ADD CONSTRAINT "FK_e40b718407120dd18e708577682" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "flow_folders" ADD CONSTRAINT "FK_315096af2aaf86bc6e7a0ef5571" FOREIGN KEY ("parent_id") REFERENCES "flow_folders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "instances" ADD CONSTRAINT "FK_efd5b1f9a934142c6b8a1c0060d" FOREIGN KEY ("proxy_id") REFERENCES "proxies"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "warmup_schedules" ADD CONSTRAINT "FK_a446a4990f2076911e2f68e2fc4" FOREIGN KEY ("instance_id") REFERENCES "instances"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "campaigns" ADD CONSTRAINT "FK_e7710203c0b031e01de765c25e7" FOREIGN KEY ("template_id") REFERENCES "templates"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "message_variations" ADD CONSTRAINT "FK_3a2c785eb41c52d76a6625e2e16" FOREIGN KEY ("campaign_id") REFERENCES "campaigns"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "campaign_contacts" ADD CONSTRAINT "FK_7265978c9afe98d1e1ed85e65da" FOREIGN KEY ("campaign_id") REFERENCES "campaigns"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "campaign_contacts" ADD CONSTRAINT "FK_2ef181b0f1a589eb8a2b515d885" FOREIGN KEY ("contact_id") REFERENCES "contacts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "campaign_contacts" DROP CONSTRAINT "FK_2ef181b0f1a589eb8a2b515d885"`,
    );
    await queryRunner.query(
      `ALTER TABLE "campaign_contacts" DROP CONSTRAINT "FK_7265978c9afe98d1e1ed85e65da"`,
    );
    await queryRunner.query(
      `ALTER TABLE "message_variations" DROP CONSTRAINT "FK_3a2c785eb41c52d76a6625e2e16"`,
    );
    await queryRunner.query(
      `ALTER TABLE "campaigns" DROP CONSTRAINT "FK_e7710203c0b031e01de765c25e7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "warmup_schedules" DROP CONSTRAINT "FK_a446a4990f2076911e2f68e2fc4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "instances" DROP CONSTRAINT "FK_efd5b1f9a934142c6b8a1c0060d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "flow_folders" DROP CONSTRAINT "FK_315096af2aaf86bc6e7a0ef5571"`,
    );
    await queryRunner.query(
      `ALTER TABLE "flow_folders" DROP CONSTRAINT "FK_e40b718407120dd18e708577682"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "FK_109638590074998bb72a2f2cf08"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tenants" DROP CONSTRAINT "FK_919d143d2411832db812bbc600e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_593b3cd99aaba561730fc1583a"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2ef181b0f1a589eb8a2b515d88"`,
    );
    await queryRunner.query(`DROP TABLE "campaign_contacts"`);
    await queryRunner.query(`DROP TABLE "message_variations"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8848968b61761dabc955081229"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_07f32d7c5e5d3c177279654fb1"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f2f4196059bf5e70faf6720fd3"`,
    );
