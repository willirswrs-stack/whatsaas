...
export class CreateMessagesTable1782490800000 implements MigrationInterface {
  name = 'CreateMessagesTable1782490800000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_messages_tenant_jid_created" ON "messages" ("tenant_id", "remote_jid", "created_at")`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_messages_tenant_instance_created" ON "messages" ("tenant_id", "instance_id", "created_at")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_messages_tenant_instance_created"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_messages_tenant_jid_created"`,
    );
