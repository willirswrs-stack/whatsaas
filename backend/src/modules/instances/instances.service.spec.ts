...
describe('InstancesService', () => {
  ...
  describe('create', () => {
    it('should create instance successfully', async () => {
      ...
      instanceRepo.create!.mockImplementation((data) => ({
        ...mockInstance(),
        ...data,
      }));
    ...
    it('should throw error if instance name already exists', async () => {
      ...
      instanceRepo.findOne!.mockResolvedValue(
        mockInstance({ instanceName: 'existing-instance' }),
      );
  ...
  describe('delete', () => {
    it('should delete instance from provider and database', async () => {
      ...
      expect(provider.deleteInstance).toHaveBeenCalledWith(
  ...
  describe('Proxy management', () => {
    ...
    describe('createProxy', () => {
      it('should create a new proxy', async () => {
        ...
        proxyRepo.create!.mockImplementation((data) => ({
          id: 'new-proxy',
          ...data,
        }));
    ...
    describe('deleteProxy', () => {
      ...
      it('should throw NotFoundException if proxy not found', async () => {
        ...
        // Act & Assert
        await expect(
          service.deleteProxy('non-existent', 'tenant-123'),
        ).rejects.toThrow(NotFoundException);
      });
    });
  });
