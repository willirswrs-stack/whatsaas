...
describe('CampaignsService', () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: getRepositoryToken(Campaign), useValue: campaignRepo },
        {
          ...
          useValue: campaignContactRepo,
        },
        {
          provide: getRepositoryToken(MessageVariation),
          useValue: variationRepo,
        },
  ...
  describe('create', () => {
    it('should create a campaign with contacts', async () => {
      ...
      campaignRepo.create!.mockImplementation((data) => ({
        ...mockCampaign(),
        ...data,
      }));
  ...
  describe('start', () => {
    it('should start a campaign with contacts', async () => {
      ...
      expect(dispatcherService.enqueueCampaign).toHaveBeenCalledWith(
        'campaign-123',
        'tenant-123',
      );
    });
    ...
    it('should throw if campaign has no contacts', async () => {
      ...
      await expect(service.start('campaign-123', 'tenant-123')).rejects.toThrow(
        /não tem contatos/,
      );
    });
  });
  ...
  describe('pause', () => {
    it('should pause a campaign', async () => {
      ...
      expect(dispatcherService.pauseCampaign).toHaveBeenCalledWith(
        'campaign-123',
      );
    });
  });
  ...
  describe('resume', () => {
    it('should resume a paused campaign', async () => {
      ...
      expect(dispatcherService.resumeCampaign).toHaveBeenCalledWith(
        'campaign-123',
        'tenant-123',
      );
  ...
  describe('delete', () => {
    it('should delete campaign and related records', async () => {
      ...
      expect(campaignContactRepo.delete).toHaveBeenCalledWith({
        campaignId: 'campaign-123',
      });
      expect(variationRepo.delete).toHaveBeenCalledWith({
        campaignId: 'campaign-123',
      });
    });
  });
  ...
  describe('Templates', () => {
    ...
    describe('createTemplate', () => {
      it('should create a new template', async () => {
        templateRepo.create!.mockImplementation((data) => ({
          ...mockTemplate(),
          ...data,
        }));
  ...
  describe('Contacts', () => {
    ...
    describe('createContact', () => {
      it('should create a new contact', async () => {
        contactRepo.create!.mockImplementation((data) => ({
          ...mockContact(),
          ...data,
        }));
