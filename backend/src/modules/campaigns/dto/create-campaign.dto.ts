...
class CampaignSettingsDto {
  ...
  @ApiProperty({
    required: false,
    example: 'random',
    enum: ['formal', 'casual', 'direct', 'mixed', 'none', 'random'],
  })
  @IsOptional()
...
export class CreateCampaignDto {
  ...
  @ApiProperty({
    required: false,
    description: 'Single instance ID (deprecated, use instanceIds)',
  })
  @IsOptional()
  @IsUUID()
  instanceId?: string;
  ...
  @ApiProperty({
    type: [String],
    required: false,
    description: 'List of Instance IDs to distribute sending',
  })
  @IsOptional()
  @IsArray()
  @IsUUID('4', { each: true })
  ...
  @ApiProperty({
    type: [String],
    required: false,
    description: 'List of Tag IDs to include contacts from',
  })
  @IsOptional()
  @IsArray()
  @IsUUID('4', { each: true })
