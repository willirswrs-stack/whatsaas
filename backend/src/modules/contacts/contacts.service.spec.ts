...
describe('ContactsService', () => {
  ...
  beforeEach(async () => {
    ...
    contactTagRepo.createQueryBuilder = jest.fn().mockReturnValue({
      ...
      getRawMany: jest
        .fn()
        .mockResolvedValue([{ tag_id: 'tag-123', count: '5' }]),
    });
  ...
  describe('Contacts CRUD', () => {
    ...
    describe('findContactById', () => {
      it('should return a contact by id', async () => {
        ...
        const result = await service.findContactById(
          'tenant-123',
          'contact-123',
        );
      ...
      it('should throw NotFoundException if not found', async () => {
        ...
        await expect(
          service.findContactById('tenant-123', 'non-existent'),
    ...
    describe('bulkDeleteContacts', () => {
      it('should delete multiple contacts', async () => {
        ...
        const result = await service.bulkDeleteContacts('tenant-123', [
          'c1',
          'c2',
          'c3',
          'c4',
  ...
  describe('Tags', () => {
    ...
    describe('findTagById', () => {
      ...
      it('should throw NotFoundException if not found', async () => {
        ...
        await expect(
          service.findTagById('tenant-123', 'non-existent'),
        ).rejects.toThrow(NotFoundException);
      });
    });
    ...
    describe('createTag', () => {
      it('should create a new tag', async () => {
        tagRepo.findOne!.mockResolvedValue(null);
        tagRepo.create!.mockImplementation((data) => ({
          ...mockTag(),
          ...data,
        }));
      ...
      it('should throw BadRequestException if tag exists', async () => {
        ...
        await expect(
          service.createTag('tenant-123', { name: 'VIP' }),
    ...
    describe('updateTag', () => {
      it('should update an existing tag', async () => {
        ...
        tagRepo
          .findOne!.mockResolvedValueOnce(tag)
  ...
  describe('Custom Fields', () => {
    ...
    describe('createCustomField', () => {
      it('should create a new custom field', async () => {
        ...
        customFieldRepo.create!.mockImplementation((data) => ({
          ...mockCustomField(),
          ...data,
        }));
        customFieldRepo.save!.mockImplementation((data) =>
    ...
    describe('updateCustomField', () => {
      it('should update a custom field', async () => {
        ...
        customFieldRepo
          .findOne!.mockResolvedValueOnce(field)
    ...
    describe('deleteCustomField', () => {
      it('should delete a custom field', async () => {
        ...
        const result = await service.deleteCustomField(
          'tenant-123',
          'field-123',
        );
