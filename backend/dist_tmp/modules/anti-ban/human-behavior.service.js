...
var HumanBehaviorService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.HumanBehaviorService = void 0;
const common_1 = require("@nestjs/common");
const delay_generator_service_1 = require("./delay-generator.service");
...
let HumanBehaviorService = HumanBehaviorService_1 = class HumanBehaviorService {
    delayGenerator;
    logger = new common_1.Logger(HumanBehaviorService_1.name);
    constructor(delayGenerator) {
     ...
     */
    generateTimingMetadata(content, config = {}) {
        const fullConfig = {
        ...
        const baseDelay = this.delayGenerator.generateGaussianDelay(fullConfig.delays.minSeconds, fullConfig.delays.maxSeconds);
        // 3. Aplicar jitter
        const jitterAppliedMs = this.delayGenerator.applyJitter(baseDelay * 1000, fullConfig.delays.jitterPercent);
        ...
        this.logger.debug(`⏱️ Timing: typing=${typingDurationMs}ms, delay=${delayBeforeSendMs}ms, ` +
     ...
     */
    async simulateHumanBehavior(content, config = {}, callbacks) {
     ...
     */
    isWithinActiveHours(startHour = '08:00', endHour = '20:00', timezone = 'America/Sao_Paulo') {
        const now = new Date();
     ...
     */
    getNextActiveTime(startHour = '08:00', endHour = '20:00', timezone = 'America/Sao_Paulo') {
        const now = new Date();
...
exports.HumanBehaviorService = HumanBehaviorService = HumanBehaviorService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [delay_generator_service_1.DelayGeneratorService])
