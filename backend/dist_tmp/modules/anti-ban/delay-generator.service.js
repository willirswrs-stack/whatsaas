...
var DelayGeneratorService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.DelayGeneratorService = void 0;
const common_1 = require("@nestjs/common");
let DelayGeneratorService = DelayGeneratorService_1 = class DelayGeneratorService {
    logger = new common_1.Logger(DelayGeneratorService_1.name);
    /**
     ...
     */
    generateGaussianDelay(minSeconds, maxSeconds) {
        ...
        this.logger.debug(`Generated gaussian delay: ${delay}s (range: ${minSeconds}-${maxSeconds}s)`);
        return delay;
    }
    /**
     * Gera delay com distribuição uniforme simples
     */
    generateUniformDelay(minSeconds, maxSeconds) {
     ...
     */
    generateExponentialDelay(minSeconds, maxSeconds, lambda = 0.5) {
     ...
     */
    applyJitter(delayMs, jitterPercent = 15) {
     ...
     */
    generateDelay(minSeconds, maxSeconds, distribution = 'gaussian', jitterPercent = 15) {
        let baseDelay;
        switch (distribution) {
            case 'gaussian':
     ...
     */
    calculateWarmupDelay(warmupDay, baseMinSeconds = 60, baseMaxSeconds = 180) {
     ...
     */
    randomizeScheduleTime(baseHour, offsetMinutes = 30) {
...
exports.DelayGeneratorService = DelayGeneratorService;
exports.DelayGeneratorService = DelayGeneratorService = DelayGeneratorService_1 = __decorate([
