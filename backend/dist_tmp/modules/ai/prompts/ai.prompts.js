...
exports.SUPPORT_AGENT_SYSTEM_PROMPT = exports.warmupConversationUserPrompt = exports.WARMUP_CONVERSATION_SYSTEM_PROMPT = exports.contentSpinnerUserPrompt = exports.CONTENT_SPINNER_SYSTEM_PROMPT = void 0;
exports.CONTENT_SPINNER_SYSTEM_PROMPT = `
...
\`\`\`
`;
const contentSpinnerUserPrompt = (originalText, variationCount, creativity) => `
...
`;
exports.contentSpinnerUserPrompt = contentSpinnerUserPrompt;
// Prompt atualizado para warm-up com formato mais específico
// Prompt atualizado para warm-up com formato mais específico
exports.WARMUP_CONVERSATION_SYSTEM_PROMPT = `
...
const warmupConversationUserPrompt = (messageCount, topics, niche) => {
...
exports.warmupConversationUserPrompt = warmupConversationUserPrompt;
exports.SUPPORT_AGENT_SYSTEM_PROMPT = `
